...
# Files/Paths
$remotePath = "padeli/deploy"
$LocalDir = "C:\Gabriel\_autoPublish\padeli_web"
...
Write-Host "Ftp desde :" $LocalDir " a " $remotePath -ForegroundColor Blue -BackgroundColor Yellow
